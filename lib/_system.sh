...
system_mv_folder() {
  ...
  sudo su - root <<EOF
  cp "${PROJECT_ROOT}"/zpro.zip /home/deployplw/${folder_name}/
EOF
...
system_unzip_zpro() {
  ...
  sudo su - deployplw <<EOF
  unzip /home/deployplw/${folder_name}/zpro.zip -d /home/deployplw/${folder_name}
EOF
...
system_success() {
  ...
  printf "\n"
  printf "Nome do Banco de Dados: ${folder_name}-postgresql"
  printf "\n"
