...
frontend_node_dependencies() {
  ...
  cd /home/deployplw/${folder_name}/zpro.io/frontend
  npm install --force
  npm i @quasar/cli
EOF
...
sudo su - deployplw << EOF
  cat <<[-]EOF > /home/deployplw/${folder_name}/zpro.io/frontend/.env
  URL_API=${backend_url}
...
sudo su - deployplw << EOF
  cat <<[-]EOF > /home/deployplw/${folder_name}/zpro.io/frontend/server.js
